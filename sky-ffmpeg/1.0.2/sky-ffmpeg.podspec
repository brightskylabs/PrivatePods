Pod::Spec.new do |spec|
  ...
  spec.author       = 'ffmpeg'
  spec.source       = { :git => 'git@github.com:brightskylabs/ffmpeg-lib.git', :tag => 'v1.0.2' }
  spec.source_files = 'include/**/*.h'
  spec.public_header_files = 'include/**/*.h'
  spec.requires_arc = false
  spec.platform = :ios, '8.0'
  spec.vendored_libraries = 'lib/*.a'
  spec.libraries = 'avcodec', 'avdevice', 'avfilter', 'avformat', 'avutil', 'swresample', 'swscale', 'postproc', 'avresample'
