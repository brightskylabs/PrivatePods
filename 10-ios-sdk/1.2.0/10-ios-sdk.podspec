Pod::Spec.new do |spec|
  ...
  spec.source = { :git => 'git@github.com:brightskylabs/10-ios-sdk.git', :tag => 'v1.2.0' }
...
EOS
  ...
  spec.dependency 'AFNetworking', '3.0.0-beta.1'
  
  spec.subspec 'Core' do |subspec|
    subspec.ios.deployment_target = '8.0'
	subspec.tvos.deployment_target = '9.0'
    subspec.source_files = 'SKYAPI.h', 'Clients/SKYAPIClient.{h,m}', 'Clients/SKYAPIRetryClient.{h,m}', 'Models/*', 'Requests/*'
